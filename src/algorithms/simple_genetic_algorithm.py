...
def run_single_ga(strategy, baseline_data, num_genes, baseline_vec, tls_to_genes, ub, out_dir, rng):
    ...
    for strat in strategies:
        try:
            best_cost, elapsed = run_single_ga(
                strat, baseline_data, num_genes, baseline_vec, tls_to_genes, ub, out_dir, rng
            )
